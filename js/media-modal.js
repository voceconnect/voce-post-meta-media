/***
 *
 * MediaModal - Create a WP 3.5+ modal window for media selection
 * 
 ***
 *
 * Example with multiple PDFs:
 *
 * <a id="set-pdf" data-attachment_ids="[34,35,36]" data-uploader_title="Select Report" href="#">Click here to attach reports</a>
 ...
 *   @param {Function} cb  Callback function for processing the selected media item; accepts attachment object as argument
 * @param {Object} [render_options]  Rendering options to pass to the modal; specifiying any option will override the default for that option
 *   @param {String} [render_options.title]  Title to display at the top of the modal; defaults to selector's 'uploader_title' data field ('data-uploader_title' attribute)
 *   @param {Object} [render_options.button]
 *	   @param {String} [render_options.button.text]  Text to display in submission button; defaults to selector's 'uploader_button_text' data field ('data-uploader_button_text' attribute)
 *	 @param {Bool} [render_options.multiple=false]  Whether users may select more than one item
 *	 @param {Object} [render_options.library]
 *	   @param {String} [render_options.library.type]  Only dispaly items of a specific MIME type (Ex: 'image', 'image/png', 'application/pdf')
 *     @param {Int} [render_options.library.uploadedTo]  Only display items uploaded to a specific post ID
 *     @param {String} [render_options.library.orderby='date']  Set the orderby for the items displayed
 *     @param {String} [render_options.library.order='DESC']  Set the order of the items displayed
 *
 ***/
